...
$(document).ready(function() {
	...
	var trackPosition = function (e) {
		...
		var relX = e.pageX - parentOffset.left;
   		...
   		var moveSpeed = (parseInt($projImg) / parseInt($projWidth)) / 10;

		//change imgpos left to match offset
		var moveImage = moveSpeed * relX * -1;
	...
	//------------------------------------
	//
	//	HEADER MOUSEOVER FUNCTIONALITY
	//
	//------------------------------------


	//make scroll top a var and create vars for elements to be edited
	
	var $header = $('header');
	var $headerHeight = $header.css('height');
	var $h1 = $('h1');
	var $a = $('header nav.main a');

	//check menu status
	var animateIn = function (state) {
